...
def reportDesign(name, th, et, pl):
	...
	os.system('grep "Kernel fmax" {}/build/acl_quartus_report.txt'.format(dir+ptype))
	os.system('head -n 90 {}/build/output_files/afu_fit.flow.rpt | tail -n 22'.format(dir+ptype))
