...
def makeMetaVariantsVitis(BOARD, AOCL_FLAGS, blocking=False):
   ...
   makeVitisXclbin(xclbin='shd_e0_3_100_100.xclbin', cl='shd_e0_3_100_100.cl', threshold=3, pattern_len=100, text_len=100, extra_flags=AOCL_FLAGS, entry_type=0, blocking=blocking, meta=meta)
   makeVitisXclbin(xclbin='shd_e0_5_100_100.xclbin', cl='shd_e0_5_100_100.cl', threshold=5, pattern_len=100, text_len=100, extra_flags=AOCL_FLAGS, entry_type=0, blocking=blocking, meta=meta)
   makeVitisXclbin(xclbin='shd_e0_7_100_100.xclbin', cl='shd_e0_7_100_100.cl', threshold=7, pattern_len=100, text_len=100, extra_flags=AOCL_FLAGS, entry_type=0, blocking=blocking, meta=meta)
